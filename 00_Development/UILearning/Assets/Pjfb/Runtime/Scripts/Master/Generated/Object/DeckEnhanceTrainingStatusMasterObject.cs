...
namespace Pjfb.Master {
    ...
    public class DeckEnhanceTrainingStatusMasterValueObject : IMasterValueObject {
		[MessagePack.Key(0)]
		public long _id {get{ return id;} set{ this.id = value;}}
		[MessagePack.Key(1)]
		public long _mDeckEnhanceId {get{ return mDeckEnhanceId;} set{ this.mDeckEnhanceId = value;}}
		[MessagePack.Key(2)]
		...
		[MessagePack.Key(6)]
		public long _deckSlotIndex {get{ return deckSlotIndex;} set{ this.deckSlotIndex = value;}}
		[MessagePack.Key(7)]
		...
		[UnityEngine.SerializeField] long mDeckEnhanceId = 0; // $mDeckEnhanceId m_deck_enhanceのid
		...
		[UnityEngine.SerializeField] long deckUseType = 0; // $deckUseType デッキ種別。m_deck_format_useのuseType
		[UnityEngine.SerializeField] long deckSlotIndex = 0; // $deckSlotIndex 効果対象枠。m_deck_format_slotのindex。-1の場合は全てに適用
		[UnityEngine.SerializeField] long targetType = 0; // $targetType 効果対象種別。deckUseTypeがキャラ関連：1=>効果対象枠のキャラが所持している練習能力に対してのみ効果加算、2=>全てに対して効果加算。deckUseTypeがトレーニング補助キャラ：1=>メイン能力、2=>サブ能力
    ...
    public class DeckEnhanceTrainingStatusMasterObjectBase {
		public virtual DeckEnhanceTrainingStatusMasterValueObject rawData => _rawData;

		public virtual long id => _rawData._id;
		public virtual long mDeckEnhanceId => _rawData._mDeckEnhanceId;
		...
		public virtual long deckSlotIndex => _rawData._deckSlotIndex;
        ...
        DeckEnhanceTrainingStatusMasterValueObject _rawData = null;
		public DeckEnhanceTrainingStatusMasterObjectBase( DeckEnhanceTrainingStatusMasterValueObject rawData ){
			_rawData = rawData;
		}
	}


	public partial class DeckEnhanceTrainingStatusMasterObject : DeckEnhanceTrainingStatusMasterObjectBase, IMasterObject {
		public DeckEnhanceTrainingStatusMasterObject( DeckEnhanceTrainingStatusMasterValueObject rawData ) : base(rawData){

		}
	}

	[System.Serializable]
    public class DeckEnhanceTrainingStatusMasterDeserializeObject : IMasterDeserializeObject
    {
        public System.Collections.IList values => m_Deck_Enhance_Training_Status;

        [UnityEngine.SerializeField]
        DeckEnhanceTrainingStatusMasterValueObject[] m_Deck_Enhance_Training_Status = null;
    }
