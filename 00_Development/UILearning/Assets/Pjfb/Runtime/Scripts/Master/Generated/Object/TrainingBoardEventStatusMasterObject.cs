...
namespace Pjfb.Master {
    ...
    public class TrainingBoardEventStatusMasterValueObject : IMasterValueObject {
		[MessagePack.Key(0)]
		...
		[UnityEngine.SerializeField] long groupNumber = 0; // $groupNumber 重複して発生しない練習能力効果をグループ化した番号。獲得した練習能力効果と既に発動している練習能力効果の groupNumber が同じ場合、効果継続ターン数を足し合わせたのち、overwritePriority に応じて効果の内容を上書きする
		[UnityEngine.SerializeField] long overwritePriority = 0; // $overwritePriority 上書き優先度。同一の groupNumber に属する複数の臨時練習能力効果を獲得した場合、ターン数の加算とともに overwritePriority の高い効果でもう一方の効果を上書きする
		...
		[UnityEngine.SerializeField] string coachEnhanceRateMapOnType = ""; // $coachEnhanceRateMapOnType xx実施時特訓発生率アップ。特定の練習種別において、特訓の発生率が上昇する。[{"practiceType":0,"rate":1500},{"practiceType":1,"rate":1000}]のように指定する
    ...
    public class TrainingBoardEventStatusMasterObjectBase {
		public virtual TrainingBoardEventStatusMasterValueObject rawData => _rawData;
        ...
        TrainingBoardEventStatusMasterValueObject _rawData = null;
		public TrainingBoardEventStatusMasterObjectBase( TrainingBoardEventStatusMasterValueObject rawData ){
			_rawData = rawData;
		}
	}
	...
	public partial class TrainingBoardEventStatusMasterObject : TrainingBoardEventStatusMasterObjectBase, IMasterObject {
		public TrainingBoardEventStatusMasterObject( TrainingBoardEventStatusMasterValueObject rawData ) : base(rawData){

		}
	}

	[System.Serializable]
    public class TrainingBoardEventStatusMasterDeserializeObject : IMasterDeserializeObject
    {
        public System.Collections.IList values => m_Training_Board_Event_Status;

        [UnityEngine.SerializeField]
        TrainingBoardEventStatusMasterValueObject[] m_Training_Board_Event_Status = null;
    }
