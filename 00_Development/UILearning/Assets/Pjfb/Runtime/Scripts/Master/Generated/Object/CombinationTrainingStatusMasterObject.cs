...
namespace Pjfb.Master {
    ...
    public class CombinationTrainingStatusMasterValueObject : IMasterValueObject {
		[MessagePack.Key(0)]
		public long _id {get{ return id;} set{ this.id = value;}}
		[MessagePack.Key(1)]
		public long _mCombinationId {get{ return mCombinationId;} set{ this.mCombinationId = value;}}
		[MessagePack.Key(2)]
		public long _progressLevel {get{ return progressLevel;} set{ this.progressLevel = value;}}
		[MessagePack.Key(3)]
		...
		[UnityEngine.SerializeField] long mCombinationId = 0; // $mCombinationId コンビネーション
		[UnityEngine.SerializeField] long progressLevel = 0; // $progressLevel 「現在の」達成度レベル。レベルは初期状態では0だが、レベル0の場合はこのデータが存在しても効果の発動は行わない。
    ...
    public class CombinationTrainingStatusMasterObjectBase {
		public virtual CombinationTrainingStatusMasterValueObject rawData => _rawData;

		public virtual long id => _rawData._id;
		public virtual long mCombinationId => _rawData._mCombinationId;
		public virtual long progressLevel => _rawData._progressLevel;
        ...
        CombinationTrainingStatusMasterValueObject _rawData = null;
		public CombinationTrainingStatusMasterObjectBase( CombinationTrainingStatusMasterValueObject rawData ){
			_rawData = rawData;
		}
	}


	public partial class CombinationTrainingStatusMasterObject : CombinationTrainingStatusMasterObjectBase, IMasterObject {
		public CombinationTrainingStatusMasterObject( CombinationTrainingStatusMasterValueObject rawData ) : base(rawData){

		}
	}

	[System.Serializable]
    public class CombinationTrainingStatusMasterDeserializeObject : IMasterDeserializeObject
    {
        public System.Collections.IList values => m_Combination_Training_Status;

        [UnityEngine.SerializeField]
        CombinationTrainingStatusMasterValueObject[] m_Combination_Training_Status = null;
    }
