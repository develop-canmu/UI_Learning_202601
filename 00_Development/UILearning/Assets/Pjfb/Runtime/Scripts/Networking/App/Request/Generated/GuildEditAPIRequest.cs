...
namespace Pjfb.Networking.App.Request {
   ...
   [Serializable]
   public class GuildEditAPIPost : AppAPIPostBase {
		...
		public string tactics = ""; // 戦略
		public long participationPriorityType = 0; // 参加優先度種別

   }

   [Serializable]
   public class GuildEditAPIResponse : AppAPIResponseBase {
   ...
   public partial class GuildEditAPIRequest : AppAPIRequestBase<GuildEditAPIPost, GuildEditAPIResponse> {
      public override string apiName{get{ return "guild/edit"; } }
   }
}